  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="./" class="logo">
        ...
        <span class="logo-mini"><b><i class="#" aria-hidden="true"></i>AK</b></span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b><i class="#" aria-hidden="true"></i>Ayam Ku</b></span>
      </a>
      <!-- Header Navbar -->
    ...
    <footer class="main-footer">
      ...
      <strong>
        <div class="cinta">Copyright © 2024 - Made with <i class="fa fa-heart pulse"></i> by <a href="#" target="_blank">Ilham & Kawan-Kawan</a></div>
      </strong>
    </footer>
